...
public class RedBlackTree {
    ...
    public static void add(int data) {
        System.out.println("Inserindo Dado : " + data);
    ...
    public static void remove(int data) {
        System.out.println("Removendo dado : " + data);
        if (root == null) {
            return;
        }
    ...
    private static void balance(Node node, String color) {
        System.out.println("Balanceando Node : " + node.data + " Cor : " + color);
    ...
    public static void balance(Node node) {
        System.out.println("Balanceando Node : " + node.data);
    ...
    private static void leftRotate(Node node) {
        System.out.println("Rotacionando Esquerda  : " + node.data);
        Node parent = node.parent;
        Node left = node.left;
        node.left = parent;
        parent.right = left;
    ...
    private static void rightRotate(Node node) {
        System.out.println("Rotacionando Direita : " + node.data);
        Node parent = node.parent;
    ...
    public static void display() {
        ...
        System.out.print("Passagem Arvore PreOrder: ");
        preOrder(root);
        System.out.println();
    }
